                    ...
                    <table class="w-full text-sm text-left text-gray-700 dark:text-gray-400">
                        ...
                        <tbody>
                            ...
                            <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">                                    
                                ...
                                <td class="py-3 px-3">
                                    <img src="{{ asset('storage') }}/{{ $user->profile_pic }}" alt="picture" width="50px" height="50px">                                    
                                </td>
                                <td class="py-3 px-3">
                                    {{ $user->name }}
                                </td>
                                ...
                                <td class="py-3 px-6">
                                    <a href="{{ route('users.pdf', ['id' => $user->id]) }}" title="get pdf" target="_blank" class="inline-flex items-center px-4 py-2 bg-indigo-500 border border-transparent rounded-md font-semibold text-xs text-white uppercase tracking-widest hover:bg-indigo-600 focus:bg-indigo-700 active:bg-indigo-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 transition ease-in-out duration-150" >PDF</a>  
